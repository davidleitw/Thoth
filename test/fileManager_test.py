...
class FileManagerTest(unittest.TestCase):
    ...
    # 創相同名稱的檔案10次
    def test_FM_createfile_Method_001(self):
    ...
    # 創不同名稱的檔案10次
    def test_FM_createfile_Method_002(self):#
        print('\n=== test fileManager.createfile function ===\n')
        # 生成 10 個隨機字串
    ...
    # 創空名稱的檔案
    def test_FM_createfile_Method_003(self):
        print('\n=== test fileManager.createfile function ===\n')
        # 空名稱
        file_name = ""
        file_path = os.path.join(FileManagerTest.test_tmp_path, file_name)
    ...
    # 創不法字元名稱的檔案
    def test_FM_createfile_Method_004(self):
        print('\n=== test fileManager.createfile function ===\n')
        # 不法字元名稱
        file_name = "?><\/:"
        file_path = os.path.join(FileManagerTest.test_tmp_path, file_name)
    ...
    # 生成國外語言檔案
    def test_FM_createfile_Method_005(self):
        print('\n=== test fileManager.createfile function ===\n')
        # 生成國外語言
    ...
    # 創不同名稱的資料夾
    def test_FM_createfolder_Method_006(self): 
    ...
    # 創相同名稱的資料夾      
    def test_FM_createfolder_Method_007(self):
        print('\n=== test fileManager.createfolder function ===\n')
        # 生成 10 個隨機字串
    ...
    # 創空名稱資料夾
    def test_FM_createfolder_Method_008(self):
        print('\n=== test fileManager.createfolder function ===\n')
        # 空名稱
        folder_name = ""
        # 獲得路徑
    ...
    # 創不法字元資料夾
    def test_FM_createfolder_Method_009(self):
        print('\n=== test fileManager.createfolder function ===\n')
        # 不法字元名稱
        folder_name = "?><\/:*|"
        # 獲得路徑
